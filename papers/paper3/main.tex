...
the approximation error $\epsilon_j$ is bounded and Rouch\'e's theorem is
...
Post-hoc certification of neural network behaviour is an active area~\cite{liu2021algorithms}
with two broad strategies: \emph{bound propagation} (interval arithmetic, abstract
