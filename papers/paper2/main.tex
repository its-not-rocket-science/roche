...
extension for non-normal matrices is described in Section~\ref{sec:dlr};
unit tests confirm correctness on DLR examples, though systematic evaluation
on non-normal and Jordan families is deferred.  Three training-time stability
...
Adam step overshoots before any relu gradient fires.  A sigmoid-constrained
model enforcing $\varrho < 0.98$ by construction achieves $100\%$ stability
on every seed.
...
momentum choices.  This is analogous to architectural stability
